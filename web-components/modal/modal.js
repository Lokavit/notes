 ...
 * @Last Modified time: 2020-07-25 22:46:59
 * doc:modal组件
 */
...
class Modal extends HTMLElement {
  constructor() {
    ...
    /** 右下区域 可拖拽 缩放 */
    this.resize = this.shadowRoot.querySelector(".resize");
  }
  ...
  connectedCallback() {
    ...
    if (this.hasAttribute("not-mask")) {
      ...
      // this.modal.classList.remove("modal_position_common");
      // this.modal.classList.add("modal_posistion_video");
    }
    ...
    //   // let dragArea = this.shadowRoot.querySelector(".modal .drag");
    //   // 为该元素绑定鼠标拖拽事件
    //   // this.drag.addEventListener("mousedown", this._drag(this.drag), false);
    //   this._drag();
    // }
